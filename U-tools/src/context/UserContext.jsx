...
export const UserContextProvider = (props) => {
  ...
  const fetchUserInfo = async () => {
    ...
    /* startLoading(); */
    try {
        const { data } = await axios.get(`https://deploy-utools-api-production.up.railway.app/api/auth/whoami/${token}`);
        setUser(data);
  ...
  const login = async (identifier, password) => {
    ...
    startLoading();
    try {
      const { data } = await axios.post("https://deploy-utools-api-production.up.railway.app/api/auth/signin", {identifier, password});
  ...
  const register = async (username, email, password/* , identifier */) => {
    startLoading();
    try {

      await axios.post("https://deploy-utools-api-production.up.railway.app/api/auth/signup", { username, email, password });
